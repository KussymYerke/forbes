    ...
    <div className="contact-page-wrapper">
      ...
      <div className="wrapper">
        <div className="image">
          ...
          <div className="content">
            <div className="article-info">
              <div className="content-title">Forbes Woman Club 2022</div>
              <a className="content-button" href="https://forbes.kz/woman/forbes_woman_club_2022_kak_nayti_sebya_v_biznese/">Прочитать статью</a>
            </div>
          </div>
        </div>
      </div>
