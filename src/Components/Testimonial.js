    ...
    <div id="priveleges" className="work-section-wrapper">
      ...
      <div className="privellege-inner">
        ...
        <div className="privellege-right">
          <p data-aos="fade-up" data-aos-once="true">Доступ к уникальным предложениям от наших партнеров. Список расширяется, следите за обновлениями <a className="privellege-bold" href={Pdfile} target="blank">здесь</a> </p>
